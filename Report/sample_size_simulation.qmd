...
trobar una diferència de proporcions de 0.025 per tenir una probabilitat del 80% 
de detectar diferències entre els dos algoritmes al final de l'estudi.
...
![sample size](figures/figure_ss.png)
...
El codi d'anàlisi es troba aquí:
